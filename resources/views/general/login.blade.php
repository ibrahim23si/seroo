...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="120x120" href="{{ asset('assets-admin/img/brand/logo.rev.png') }}">
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{ asset('assets-admin/img/brand/logo.rev.png') }}">
    <link rel="icon" type="image/png" sizes="16x16"
        href="{{ asset('assets-admin/img/brand/logo.rev.png') }}">
    <link rel="manifest" href="{{ asset('assets-admin/img/brand/logo.rev.png') }}">
    <link rel="mask-icon" href="{{ asset('assets-admin/img/brand/logo.rev.png') }}" color="#ffffff">
        ...
        <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
            <div class="container">
                ...
                <div class="row justify-content-center form-bg-image"
                    ...
                    style="background: url(&quot;../../assets/img/illustrations/signin.svg&quot;);">
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500"style="background-color: #8e1a08;">
                            ...
                            @endif
                            <form action="{{ route('login.admin.check') }}" method="POST" class="mt-4">
                                @csrf
                                <!-- Form -->
                                <div class="mb-4">
